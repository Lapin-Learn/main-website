  ...
  content: [
    {
      ...
      content: [
        {
          type: "text",
          text: "How tennis rackets have changed",
        },
      ],
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `In 2016, the British professional tennis player Andy Murray was ranked as the world's
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `Of the changes that account for this transformation, one was visible and widely
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `The modification that Murray made is just one of a number of options available to
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `The primary reason for these modifications is simple: as the line between winning and
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `Racket modifications mainly date back to the 1970s, when the amateur German tennis
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `Modifications can be divided into two categories: those to the string bed and those to
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `At one time, all tennis rackets were strung with natural gut made from the outer layer
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `Of the synthetics, co-polyester is by far the most widely used. It's a perfect fit for
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `Other changes to the frame involve the handle. Players have individual preferences for
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: `Racket customisation and modification have pushed the standards of the game to greater
