  ...
  if (loading) {
    return (
      <div className="flex min-h-40 items-center justify-center rounded-lg bg-opacity-80 p-8">
        <Loader2 className="size-12 animate-spin text-black opacity-20 dark:text-white" />
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <div>
          <Button disabled={draggedInside} onClick={handleUploadClick} variant="outline" size="sm">
            <Icon name="Upload" />
            Upload an image
          </Button>
        </div>
