...
>(({ className, orientation, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb
      className={
        "block size-4 rounded-full border border-primary bg-background shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
      }
    />
  </SliderPrimitive.Root>
));
